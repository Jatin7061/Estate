...
const UpdateListing = () => {
  ...
  return (
    <main className='p-3 max-w-4xl mx-auto'>
      <h1 className='text-xl text-center my-5'>Update Listing</h1>
      <form  className='flex flex-col sm:flex-row gap-6'>
        ...
        <button 
        onClick={handleSubmit || Uploading} disabled={loading} className='p-3 bg-slate-700 text-white rounded-lg uppercase hover:opacity-95 disabled:opacity-80'>{loading ? 'Listing':'Update listing'}</button>
